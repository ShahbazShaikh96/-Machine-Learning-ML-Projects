...
### Conclusion
Both the empirical (pivot table) and theoretical (Naive Bayes) estimates produced nearly identical probabilities (≈0.0965). This confirms that the independence assumption of Naive Bayes performs well for these variables, and that customers who both own a credit card and use online banking have about a 9.6% chance of accepting a personal loan.
